...
from nets.UNet3Plus import UNet3Plus, UNet3Plus_DeepSupervision, UNet3Plus_DeepSupervision_CGM
from nets.UNet3Plus_training import *
...
if __name__ == "__main__":
    ...
    model = UNet3Plus(num_classes=num_classes, pretrained=pretrained).train()
    if not pretrained:
        weights_init(model)
    if model_path != '':
        #------------------------------------------------------#
